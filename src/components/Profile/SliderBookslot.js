...
// Assuming you have already defined the functions convertTimeTo12HourFormat, handleConfirm, and handleBookSlot
const screenWidth = Dimensions.get("window").width;

const SliderBookSlot = ({ username }) => {
  ...
  return (
    ...
    >
      ...
      <Text
        style={{ fontSize: 14, fontWeight: 600, marginStart: 24, marginTop: 4 }}
      >
        Pick a date
      </Text>
      <FlatList
            ...
            <View style={styles.maincontainer}>
              <TouchableOpacity
                style={[
                  ...
                  {
                    backgroundColor:
                      selectedDate === item.booking_day ? "#5d20d2" : "white", // Check the color values and conditions
                    color:
                      selectedDate === item.booking_day ? "white" : "black", // Check the color values and conditions
                  },
                ]}
